...
public class ReportFolder {
    ...
    static String filePathReport = System.getProperty("user.dir")+"\\src\\main\\java\\Reports\\Add_Combi_Card_Numbers_Reports";
   ...
   // static String PathName ="C:\\Reports";
    ...
    public static void ReportDirectory() throws IOException {
        ...
        File testFolder = new File( rootReportFolder + File.separator +  "Combi_Card_Numbers_Report");
