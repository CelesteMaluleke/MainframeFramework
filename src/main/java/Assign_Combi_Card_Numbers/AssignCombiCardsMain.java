...
public class AssignCombiCardsMain {
    ...
    {
        String filePath = System.getProperty("user.dir")+"\\Data_File\\Assign_Combi_Card_Numbers_Excel\\DebitCardSheet.xlsx";
        ...
        try {
            ...
            for(int y = 1; y < ExcelFunctions.ScenarioCount; y++)
            {
                ...
                try {
                    ...
                    if (runStatus.equalsIgnoreCase("RUN")) {
                        ...
                        if (userLoggedIn) {
                            ...
                            if (ChechPoint != null) {
                                ...
                                if (ChechPoint.equalsIgnoreCase("CMMI  NEW  Additional Combi Card, Card Fee will be charged") || ChechPoint.equals("")) {
                    ...
                    System.out.print("failed COMBI: "+cardNo);
                    assignCardsJC.close();
