...
public class ReportFolder {
    ...
    static String filePathReport = System.getProperty("user.dir")+"\\src\\main\\java\\Reports\\Personal_Loan\\Reference";
   ...
   // static String PathName ="C:\\Reports";
    ...
    public static void ReportDirectory() throws IOException {
        ...
        File testFolder = new File( rootReportFolder + File.separator +  "Creating_New_Customer_On_MainFrame_Report");
        ...
        String reportFolderName = "Automated Test Execution Report_" + new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.
                 Date());
