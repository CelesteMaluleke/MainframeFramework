...
public class ExcelFunctions {
    ...
    public void WriteToCell(String results, String runStatus, String accountNo,String comment, int iScenario,int ColumnCount, int ColumnC, int ColumnAccountNo, int ColumnComment) throws IOException {
