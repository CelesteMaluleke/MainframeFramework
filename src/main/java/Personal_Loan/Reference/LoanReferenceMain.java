package Personal_Loan.Reference;
...
public class LoanReferenceMain {
    ...
    private LoanReferenceJagacy jc = null;
    ...
    public void TestCustomerBoarding()throws JagacyException, InterruptedException, IOException
    {
        ...
        String filePath = System.getProperty("user.dir")+"\\Data_File\\Personal_Loan\\Reference\\PersonalLoanReferenceSheet.xlsx";
                ...
                try {
                    ...
                    if (runStatus.equalsIgnoreCase("RUN")) {
                        ...
                        if (validTest) {
                            ...
                            message = jc.PersonalLoanReference(userData, idNumber, surname, intials, Title, Gender, clientType, accountOption,
                                    ...
                                    PostQualification, socialGrant, DateIdentified, empNo, DateVerified, ProductType, methodDelivary, TaxNo, FOREIGNTAX, sourceFund, count);

                            if (message.equalsIgnoreCase("") || message.equalsIgnoreCase("INVALID INITIALS ENTERED") || message.equalsIgnoreCase("INVALID SITE FOR CAPTURE") || message.equalsIgnoreCase("ABSA ISLAMIC PRIVATE ACCOUNT MAY ONLY BE OPENED BY") || message.equalsIgnoreCase("ACC TYPE ONLY VALID FOR ABSA WEALTH SITES") || message.equalsIgnoreCase("ACCOUNT TYPE AND BANKING SECTOR INCOMPATIBLE") || message.equalsIgnoreCase("STRUCTURED LOAN MAY ONLY BE OPENED BY A PRIVATE BA") || message.equalsIgnoreCase("INVALID CATEGORY") || message.equalsIgnoreCase("client already exists") || message.equalsIgnoreCase("BIRTH DATE NOT THE SAME AS IN ID NUMBER") || message.equalsIgnoreCase("INVALID CHARACTERS IN NAME") || message.equalsIgnoreCase("DATE ISSUED CANNOT BE LESS THAN DATE OF BIRTH") || message.equalsIgnoreCase("ID NUMBER INVALID") || message.equalsIgnoreCase("CLIENT TYPE AND ACCOUNT TYPE INCOMPATIBLE") || message.equalsIgnoreCase("INCOMPATIBLE CATEGORY AND DATE OF BIRTH") || message.equalsIgnoreCase("DUPLICATE RECORDS EXIST, PLEASE RESOLVE")) {
