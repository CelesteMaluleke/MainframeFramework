...
public class LoanReferenceJagacy extends Session3270
{
    ...
    public LoanReferenceJagacy() throws JagacyException
    {
    ...
    public String personalLoanAcceptQuote(String accountNumber) throws JagacyException {
        ...
        userIdRow = 15;
        userIdColumn = 45;
        this.writePosition(userIdRow, userIdColumn,"200000");
        ...
        userIdRow = 6;
        userIdColumn = 25;
        this.writePosition(userIdRow, userIdColumn,"20190820");
    ...
    public String PersonalLoanReference(String userData, String idNumber, String surname, String intials, String Title, String Gender,
                                     ...
                                     String DateVerified, String ProductType, String methodDelivary , String TaxNo, String FOREIGNTAX , String sourceFund, int count) throws JagacyException
    {
...
//            System.out.println("Messages: " + message);
            ...
            userIdRow = 7;
            userIdColumn = 24;
            this.writePosition(userIdRow, userIdColumn, "99999");
/*
            userIdRow = 8;
            userIdColumn = 24;
...
//            System.out.println("Messages: " + message);
            ...
            userIdRow = 7;
            userIdColumn = 24;
            this.writePosition(userIdRow, userIdColumn, "Mathobela");

            userIdRow = 8;
            userIdColumn = 24;
            this.writePosition(userIdRow, userIdColumn, "Jacobs");

            userIdRow = 9;
            userIdColumn = 24;
            this.writePosition(userIdRow, userIdColumn, "05");

            userIdRow = 12;
            userIdColumn = 24;
            this.writePosition(userIdRow, userIdColumn, "0727642310");

            userIdRow = 13;
            userIdColumn = 9;
            this.writePosition(userIdRow, userIdColumn, "Testdata@absa.co.za");
...
//            userIdRow = 18;
//            userIdColumn = 49;
//            this.writePosition(userIdRow, userIdColumn, "8392");
...
//            System.out.println("Message Empo Stuff: " + message);
            ...
            if(message.equalsIgnoreCase("MONTHLY INCOME MANDATORY FOR ACSP"))
            {
                userIdRow = 4;
                userIdColumn = 23;
                this.writePosition(userIdRow, userIdColumn, MonthlyIncome);
...
//            File source = new File("C:\\Users\\ABTS777\\Documents\\TestDataManagementAutomationFrawork\\Data_File\\Personal_Loan\\Reference\\");
//            File dest = new File("C:\\Users\\ABTS777\\Documents\\TestDataManagementAutomationFrawork\\Data_File\\Personal_Loan\\finalSheet\\");
//            try {
