package Create_Existing_Customer;
...
public class ReportFolder {
    ...
    static String filePathReport = System.getProperty("user.dir")+"\\src\\main\\java\\Reports\\Create_Existing_Customer_Results";
   ...
   // static String PathName ="C:\\Reports";
    ...
    public static void ReportDirectory() throws IOException {
        ...
        File testFolder = new File( rootReportFolder + File.separator +  "Create_Existing_Customer_Report");
