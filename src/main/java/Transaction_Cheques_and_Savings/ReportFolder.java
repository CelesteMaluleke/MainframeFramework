...
public class ReportFolder {
   ...
   static String filePathReport = System.getProperty("user.dir")+"\\src\\main\\java\\Reports\\Transaction_Cheques_And_Savings_Reports";
   // static String PathName ="C:\\Reports";
    ...
    public static void ReportDirectory() throws IOException {
        ...
        File testFolder = new File( rootReportFolder + File.separator +  "TransactionChequesAndSavings_Reports");
