...
public class TransactionsJagacy extends Session3270
{
    ...
    //Cash Withdrawal (CW)
    public String cashWithdraw(String userData, String transactionType, String accountNo, String amount, String transactionNo, String controllerID) throws JagacyException {
        try {
            Robot rob = new Robot();
            this.waitForChange(1000);
            userIdRow = 2;
