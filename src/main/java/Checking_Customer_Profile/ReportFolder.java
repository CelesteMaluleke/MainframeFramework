...
public class ReportFolder {
    ...
    static String filePathReport = System.getProperty("user.dir")+"\\src\\main\\java\\Reports\\Checking_Customer_Profile_Reports";
   ...
   // static String PathName ="C:\\Reports";
    ...
    public static void ReportDirectory() throws IOException {
        ...
        File testFolder = new File( rootReportFolder + File.separator +  "CheckingCustomerProfile_Reports");
